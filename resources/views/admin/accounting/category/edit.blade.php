...
<div class="content-wrapper">
    ...
    <x-custom.header-page title="{{ __('buttons.edit_category') }}" />
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form id="form1" action="{{ route('admin.accounting.categories.update', $category->id) }}"
                            ...
                            <div class="card-body row">
                                ...
                                <div class='form-group row col-md-6'>
                                    <x-input-label
                                        class="col-sm-12 col-form-label">{{ __('attributes.type') }}</x-input-label>
                                    <div class="col-sm-12">
                                        <select name="type" class="form-control select2">
                                            <option disabled>{{ __('buttons.choose') }}</option>
                                            @foreach ($typeOptions as $typeOption)
                                            <option value="{{ $typeOption['value'] }}"
                                                @if ($category->type->value == $typeOption['value']) selected @endif>
                                                    {{ $typeOption['label'] }}
                                            </option>
                                            @endforeach
                                        </select>
