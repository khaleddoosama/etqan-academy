...
@section('content')
    <div class="content-wrapper">
        ...
        <x-custom.header-page title="{{ __('buttons.create_program') }}" />
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <img src="" alt="" width="50" id="icon-preview">
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form id="form1" action="{{ route('admin.programs.store') }}" method="POST"
