...
@section('content')
    <div class="content-wrapper">
        ...
        <x-custom.header-page title="{{ __('buttons.create_role') }}" />
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">{{ __('buttons.create') }} <small>{{ __('main.role') }}</small></h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form id="quickForm" action="{{ route('admin.role.store') }}" method="POST"
